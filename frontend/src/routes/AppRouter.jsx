...
/>
        ...
        <Route
          path="/admin/results"
          element={<PrivateRoute allowedRoles={['admin', 'teacher']}><Results /></PrivateRoute>}
        />
        <Route
          path="/admin/users"
        ...
        <Route
          ...
          element={<PrivateRoute allowedRoles={['admin']}><QuestionList /></PrivateRoute>}
        />
        <Route
          path="/admin/quizzes"
          element={<PrivateRoute allowedRoles={['admin']}><QuizList /></PrivateRoute>}
        />
